...
import { ShuffledQuestion } from '../../utils/questionUtils';
...
export default function TVDisplayScreen() {
  ...
  const handleQuestionData = (questionData: any) => {
    ...
    // Update game state
    setGameState({
      currentRound: 1, // This could be derived from round data
      currentQuestion: questionData.question_number || 1,
      totalQuestions: 10, // This could be derived from round data
  ...
  const handleGameEnded = () => {
    ...
    setShowingResults(false);
    loadPartyData(); // Refresh final scores
  };
